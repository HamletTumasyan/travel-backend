...
const activeRoute = 'contact-page';
const prismaTable = "contactPageFormContent";
const currentView = "contactPage";
const listPageTitle = "Contact Page";
const createPageTitle = "Create Contact Page Content";
const detailPageTitle = "Detail Contact Page Content";
